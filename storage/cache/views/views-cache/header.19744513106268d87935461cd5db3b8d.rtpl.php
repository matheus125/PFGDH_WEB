    ...
    <nav class="app-header navbar navbar-expand bg-body">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-md-block"><a href="/admin/index" class="nav-link">Home</a></li>
        </ul>
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
              <img src="/res/admin/dist/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow"
                alt="User Image" />
    ...
    <aside class="app-sidebar bg-body-secondary" data-bs-theme="light">
      ...
      <div class="sidebar-brand">
        ...
        <a href="/admin/index" class="brand-link">
          ...
          <!--end::Brand Image-->
          <!--begin::Brand Text-->
          <span class="brand-text fw-light">TESTE</span>
          <!--end::Brand Text-->
        </a>
        <!--end::Brand Link-->
      </div>
          ...
          <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="/admin/relatorio/senhas" class="nav-link active">
                    <i class="nav-icon bi bi-circle"></i>
                    <p>Expediente</p>
                  </a>
                </li>
