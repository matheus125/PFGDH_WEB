<?php if(!class_exists('Rain\Tpl')){exit;}?><style>
    ...
    .kpi .value { font-size: 2rem; font-weight: 900; margin-top: 6px; }
    ...
    @media (max-width: 768px) {
        .top-bar .row>div { margin-bottom: 10px; }
    }
</style>
        ...
        <div class="container-fluid">
            ...
            <div class="top-bar mb-3">
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        <button class="btn btn-primary w-100" type="button" onclick="atualizarRelatorio()">Atualizar</button>
                    </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-2 col-6"><div class="kpi"><div class="label">Total</div><div class="value" id="kpiTotal">0</div></div></div>
                <div class="col-md-2 col-6"><div class="kpi"><div class="label">Normal</div><div class="value" id="kpiNormal">0</div></div></div>
                <div class="col-md-2 col-6"><div class="kpi"><div class="label">Genérica</div><div class="value" id="kpiGenerica">0</div></div></div>
                <div class="col-md-2 col-6"><div class="kpi"><div class="label">Dependentes</div><div class="value" id="kpiDependentes">0</div></div></div>
                <div class="col-md-2 col-6"><div class="kpi"><div class="label">Titulares</div><div class="value" id="kpiTitulares">0</div></div></div>
                <div class="col-md-2 col-6"><div class="kpi"><div class="label">Deficientes</div><div class="value" id="kpiDeficientes">0</div></div></div>
            </div>
                    ...
                    <div class="box p-2">
                        <div class="d-flex justify-content-between align-items-center flex-wrap" style="gap:.5rem;">
                            ...
                            <div class="d-flex align-items-center" style="gap:.5rem;">
                                ...
                                <button id="listaPrev" class="btn btn-sm btn-outline-secondary" type="button">Anterior</button>
                                <span id="listaPageIndicator" class="small text-muted"></span>
                                <button id="listaNext" class="btn btn-sm btn-outline-secondary" type="button">Próxima</button>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center" style="gap:.5rem;">
                                ...
                                <div class="btn-group btn-group-sm" role="group" aria-label="Ordenar Top 10">
                                    <button id="btnOrdFreq" type="button" class="btn btn-outline-secondary active" onclick="setOrdenacaoTop('FREQ')">Frequência</button>
                                    <button id="btnOrdRef" type="button" class="btn btn-outline-secondary" onclick="setOrdenacaoTop('REFEICOES')">Refeições</button>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive mt-2">
                    ...
                    <div class="box p-2">
                        <div class="d-flex justify-content-between align-items-center flex-wrap" style="gap:.5rem;">
                            ...
                            <div class="d-flex" style="gap:.5rem;">
                                <input type="month" id="relMes" class="form-control form-control-sm" style="width:auto;" />
                                <button class="btn btn-sm btn-primary" type="button" onclick="atualizarMensal()">Ver</button>
                            </div>
                        </div>
...
<script>
    ...
    // Top 10: ordenação
    let topOrder = 'FREQ'; // FREQ | REFEICOES
    ...
    async function carregarResumo() {
        ...
        document.getElementById("kpiNormal").textContent = r.normal ?? 0;
