<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="card card-info card-outline mb-4">
    ...
    <form class="needs-validation" id="form-cliente-update" action="/admin/clientes/update" method="post" novalidate>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control form-control-sm" id="nome_completo" name="nome_completo"
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="nome_mae" name="nome_mae"
                        value="<?php echo htmlspecialchars( $clientes["nome_mae"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select form-select-sm" id="estado_civil" name="estado_civil" required>
                        <option value="">Selecione</option>
                        <option value="Solteiro(a)" {if="$clientes.estado_civil=='Solteiro(a)'" }selected<?php  ?>>
                            Solteiro(a)</option>
                        <option value="Casado(a)" {if="$clientes.estado_civil=='Casado(a)'" }selected<?php  ?>>Casado(a)
                        </option>
                        <option value="Divorciado(a)" {if="$clientes.estado_civil=='Divorciado(a)'" }selected<?php  ?>>
                            Divorciado(a)</option>
                        <option value="Viúvo(a)" {if="$clientes.estado_civil=='Viúvo(a)'" }selected<?php  ?>>Viúvo(a)
                        </option>
                        <option value="União Estável" {if="$clientes.estado_civil=='União Estável'" }selected<?php  ?>>União
                            Estável</option>
                    </select>
                </div>
                ...
                <div class="col-md-1">
                    ...
                    <input type="number" class="form-control form-control-sm" id="idade_cliente"
                        value="<?php echo htmlspecialchars( $clientes["idade"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" readonly>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="rg" name="rg" value="<?php echo htmlspecialchars( $clientes["rg"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                        required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="cpf" name="cpf" value="<?php echo htmlspecialchars( $clientes["cpf"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                        required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="nis" name="nis" value="<?php echo htmlspecialchars( $clientes["nis"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                ...
                <div class="col-md-6">
                    <label class="form-label">Nome da Família</label>
                    <input type="text" class="form-control form-control-sm" id="nome_familia" name="nome_familia"
                        value="<?php echo htmlspecialchars( $clientes["familia"]["0"]["nome_familia"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm" id="telefone" name="telefone"
                        value="<?php echo htmlspecialchars( $clientes["telefone"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="cep" name="cep" value="<?php echo htmlspecialchars( $clientes["cep"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                        required>
                </div>

                <div class="col-md-4">
                    <label class="form-label">Rua</label>
                    <input type="text" class="form-control form-control-sm" id="rua" name="rua" value="<?php echo htmlspecialchars( $clientes["rua"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"
                        required>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="numero" name="numero"
                        value="<?php echo htmlspecialchars( $clientes["numero"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                </div>

                <div class="col-md-3">
                    <label class="form-label">Bairro</label>
                    <input type="text" class="form-control form-control-sm" id="bairro" name="bairro"
                        value="<?php echo htmlspecialchars( $clientes["bairro"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                </div>

                <div class="col-md-3">
                    <label class="form-label">Cidade</label>
                    <input type="text" class="form-control form-control-sm" id="cidade" name="cidade"
                        value="<?php echo htmlspecialchars( $clientes["cidade"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" required>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="tempo_moradia_cliente"
                        name="tempo_moradia_cliente" value="<?php echo htmlspecialchars( $clientes["tempo_moradia_anos"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>
...
<script>
    $(document).ready(function () {
        ...
        async function verificarDuplicidade(campo, valor) {
            ...
            const idsB64 = document.querySelector("input[name='ids_b64']").value;

            const resposta = await fetch(
                `/admin/clientes/verificar-${campo}?valor=` +
                encodeURIComponent(valor) +
                `&ids_b64=` +
                encodeURIComponent(idsB64)
            );
            ...
            try {
                ...
                console.error("Erro na rota verificar-" + campo, texto);
                return false;
            }
        }
        ...
        $("#form-cliente-update").on("submit", async function (e) {
            e.preventDefault();
    ...
    $(document).ready(function () {
        ...
        function marcarCampoInvalido(campo, mensagem = "Este campo é obrigatório.") {
            campo.addClass("campo-invalido");

            if (campo.next(".texto-erro-campo").length === 0) {
                campo.after('<span class="texto-erro-campo">' + mensagem + '</span>');
            }
        }

        function limparCampoInvalido(campo) {
            campo.removeClass("campo-invalido");
            campo.next(".texto-erro-campo").remove();
        }

        $("#form-cliente-create input, #form-cliente-create select, #form-cliente-update input, #form-cliente-update select").on("input change", function () {
            const campo = $(this);
        ...
        $("#form-cliente-create, #form-cliente-update").on("submit", function (e) {
            ...
            if (possuiErro) {
                ...
                Swal.fire({
                    ...
                    text: "Preencha os campos obrigatórios destacados em vermelho."
                });
