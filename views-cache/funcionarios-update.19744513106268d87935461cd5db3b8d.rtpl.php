            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <select name="perfil" id="perfil" class="form-control" required>
                  ...
                  <option value="ADMIN" <?php if( $funcionarios["perfil"]=='ADMIN' ){ ?>selected<?php } ?>>
                    Administrador
                  </option>

                  <option value="SUPERVISOR" <?php if( $funcionarios["perfil"]=='SUPERVISOR' ){ ?>selected<?php } ?>>
                    Supervisor
                  </option>

                  <option value="ASSESSOR" <?php if( $funcionarios["perfil"]=='ASSESSOR' ){ ?>selected<?php } ?>>
                    Assessor
                  </option>
